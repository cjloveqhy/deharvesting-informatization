...
<template>
  <n-form
    ...
    :rules="rules"
  >
    <n-tabs animated v-model:value="tab" type="line" size="large">
        ...
        <n-flex :wrap="false" :size="100" class="mt-6">
          <n-flex vertical class="w-1/3" align="center">
            <n-form-item path="photo">
              ...
              <template v-else>
                <n-avatar :size="210" round :src="userInfo.photo && userInfo.photo !== '' ? userInfo.photo : null">
      ...
      <n-tab-pane name="security" tab="安全设置">
        <n-flex class="mt-6 pl-6" vertical>
